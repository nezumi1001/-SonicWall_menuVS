...
//	public static String baseUrl = "https://10.103.50.113"; // TZ 270W
    ...
    //	public static String userName_path = "//input[contains(@placeholder,'ユーザ名を入力')]"; // 7.0.1
    public static String login_name = "admin";
    // Password field
    public static String password_path = "//input[contains(@placeholder,'パスワードを入力')]";
//	public static String password_path = "//input[contains(@placeholder,'パスワードを入力')]"; // 7.0.1
...
//			{ "法的情報", "Legal Information" }, { "API", "API" } };
    ...
    // MONITOR
    public static String[][] leftPane_MONITOR = { { "リアルタイム グラフ", "Real-Time Charts" },
            { "リアルタイム監視", "System Monitor" }, { "システム監視", "System Monitor" }, { "プロトコル監視", "Protocol Monitor" },
            { "ユーザ監視", "User Monitor" }, { "帯域幅管理監視", "BWM Monitor" }, { "AppFlow", "AppFlow" },
            { "AppFlow 報告", "AppFlow Report" }, { "AppFlow 監視", "AppFlow Monitor" }, { "CTA レポート", "CTA Report" },
            { "SDWAN", "SDWAN" }, { "SDWAN 監視", "SDWAN Monitor" }, { "SD-WAN 接続", "SD-WAN Connections" },
            { "ログ", "Logs" }, { "システム ログ", "System Logs" }, { "監査ログ", "Auditing Logs" }, { "脅威ログ", "Threat Logs" },
            { "ツールと監視", "Tools & Monitors" }, { "パケット監視", "Packet Monitor" }, { "接続", "Connections" },
