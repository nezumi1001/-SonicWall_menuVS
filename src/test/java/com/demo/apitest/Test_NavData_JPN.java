...
//        chromOptions.addArguments("--no-sandbox"); // Bypass OS security model
//        chromOptions.addArguments("--disable-dev-shm-usage"); // overcome limited resource problems
//        chromOptions.addArguments("disable-infobars"); // disabling infobars
//        chromOptions.addArguments("--disable-extensions"); // disabling extensions
//        chromOptions.addArguments("--disable-gpu"); // applicable to windows os only
